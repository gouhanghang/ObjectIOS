...
- (void)initialization
{
    ...
    _bannerImageViewContentMode =UIViewContentModeScaleAspectFill;//UIViewContentModeScaleToFill;
...
//    self.curIndexPage = indexOnPageControl;
...
//            NSLog(@"pageControl.currentPage:%ld", pageControl.currentPage);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.imageView.contentMode = _imageContenMode;
